                    ...
                    <MDBCol lg="4" className="bg-grey">
                      <div className="p-5">
                        ...
                        <div className="d-flex justify-content-between mb-4">
                          ...
                          <MDBTypography tag="h5">LKR {cart && cart.bill}</MDBTypography>
                        </div>
                        ...
                        <div className="d-flex justify-content-between mb-1">
                          ...
                          <MDBTypography tag="h5">LKR {cart && cart.bill}
                          </MDBTypography>
                        </div>
                        <div className="d-flex justify-content-between mb-1">
                          <MDBTypography tag="h5" className="text-uppercase">
                          ...
                          <MDBTypography tag="h5">LKR {cart && (cart.discount * cart.bill).toFixed(2)}
                          </MDBTypography>
                        </div>
                        <div className="d-flex justify-content-between mb-1">
                          <MDBTypography tag="h5" className="text-uppercase">
                          ...
                          <MDBTypography tag="h5">LKR {cart && cart.bill-(cart.discount * cart.bill).toFixed(2)}
                          </MDBTypography>
                        </div>
