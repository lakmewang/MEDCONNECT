	...
	return (
      ...
      >
        <MDBContainer className="py-5 h-100">
          ...
          <MDBCol md="2" className="text-center d-flex justify-content-center align-items-center">
            <p className="text-muted mb-0 small">LKR{item.price}</p>
          </MDBCol>
        </MDBRow>
        <hr
                        className="mb-4"
                  ...
                  <div className="d-flex justify-content-between pt-2">
                    ...
                    <p className="text-muted mb-0">
                      <span className="fw-bold me-4">Total LKR</span> {order.bill}
                    </p>
                  </div>
                ...
                >
                  ...
                  >
                    Total paid: LKR <span className="h2 mb-0 ms-2">{order.bill}</span>
                  </MDBTypography>
                </MDBCardFooter>
              </MDBCard>
            </MDBCol>
