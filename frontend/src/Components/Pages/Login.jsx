    ...
    return (
      ...
      <Stack direction="column" spacing={7} alignItems="center" w="100%" h="100%" justify="center">
        ...
        <Box alignSelf="flex-start" mx={3} textAlign='start'>
          <Text fontSize="6xl" mb={2} as='abbr'  color={'#005660'} fontWeight={'bold'}> Empower Your Well-being, <br /> Just One Tap Away!</Text>
        </Box>
        <Box alignSelf="flex-start" mx={3} textAlign='start'>
          <Text fontSize="2xl" as='cite'> "Unlock access to premier doctors and seamless healthcare. Your wellness journey begins here." </Text>
        </Box>
        <HStack alignSelf={'start'} my={10} mx={10} >
          ...
          <Text fontWeight={'medium'}> Join 5,000+ Users</Text>
        </HStack>
      </Stack>
